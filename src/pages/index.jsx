          ...
          <Row>
            <Col space='12'>
              <div className={styles.portfolio_banner}>
                <span className={styles.portfolio_banner_subheading}>Hey! I am</span>
                <div className={styles.portfolio_profile}>
                  <div className={styles.portfolio_img}>
                    <img className={styles.portfolio_profile_img} src='./icons/profile_img.jpg' alt='profile' />
                  </div>
